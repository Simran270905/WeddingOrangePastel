...
const EventDetails = () => {
  ...
  return (
    <section className="relative py-20 bg-gradient-to-br from-orange-50 via-rose-50/40 to-amber-50/50 overflow-hidden">
      {/* Floating Decoration */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="mx-auto w-24 h-1.5 bg-gradient-to-r 
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
  {events.map((event, idx) => (
    ...
    >
      ...
      <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white/80 
