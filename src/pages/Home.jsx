...
const Home = () => {
  ...
  useEffect(() => {
    document.title = "Omkar & Harini | Wedding Invitation";
  }, []);
  ...
  // Parallax progress for global effects
  const pageVariants = {
    initial: { 
      opacity: 0, 
  ...
  const gradientVariants = {
    initial: { 
      background: "radial-gradient(circle at 20% 80%, rgba(252,165,56,0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(239,68,68,0.2) 0%, transparent 50%)"
    },
    animate: { 
      background: "radial-gradient(circle at 20% 80%, rgba(252,165,56,0.4) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(239,68,68,0.3) 0%, transparent 50%)",
      transition: {
        duration: 20,
        repeat: Infinity,
        repeatType: "reverse"
  ...
  return (
    ...
    >
      ...
      {/* Custom cursor for wedding theme */}
      <motion.div
